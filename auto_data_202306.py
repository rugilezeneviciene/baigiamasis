import pandas as pd
# default yra kad csv failuose duomenys buna atskirti kableliais, taciau musu atveju reikia pazymeti kad atskiria ;
# data = pd.read_csv('2023_01-06 LT auto pardavimai cl.csv', delimiter=';')
#
# #valome duomenis ir formatuojame kaip lentele:
# #panaikiname tuscias eilutes ir stulpelius
# data = data.dropna(how='all', axis=0)
# data = data.dropna(how= 'all', axis=1)
# #priskiriame stulpeliu pavadinimus:
# column_names = ['Naudota_nauja', 'Degalu_rusis', '2023_01', '2023_02', '2023_03','2023_04',
#                 '2023_05','2023_06', 'Is_viso_2023_1_pusm']
...
def main():
    ...
    # ##get column names
    # column_names=get_columns_names(joined_data5)
    # print("column names for entire period: ")
    # print(column_names)
